...
material find_material(Id  id, Materiais const &materiais);
Produtos load_produto(Materiais const &mat, Pecas const &pecas);
Produtos load_all();

void sort_preco(Produtos &produtos);
void sort_peso(Produtos &produtos);
void sort_material(Produtos &produtos);
void save(Produtos const &produtos, Local nome);
